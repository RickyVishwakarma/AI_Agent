...
//                 // convert messges to langchain format
...
//                 } catch (streamError) {
//                     console.log("Error in event steam :", streamError);
//                     await sendSSEMessage(writer, {
...
//                     await writer.close();
//                 } catch (closeError) {
//                     console.error("Error in chat API", closeError);
//                 }
...
//         } catch (err) {
//             console.error("Error is chat API: ", error);
//             return NextResponse.json(
//                 { error: "Falied to process chat request" } as const,
//                 { status: 500 }
