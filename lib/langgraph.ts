...
//     //if the last message is a tool mesage , route back to agent
...
//             // Create the prompr template with system message placeholder

//             const promptTemplate = ChatPromptTemplate.fromMessages([
//                 new SystemMessage(systemContent, {
//                     cache_control: {type : "ephemeral"},// set a cache breakepoint (max number of breakepoint is 4)
//                 }),
...
//             // Fomat the prompt with the current messages
...
//             if(humanCount === 2){
//                 //  console.log("caaching second-to-last human message");
